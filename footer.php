...
<li class="footer-tabbar__item">
			...
			<li class="footer-tabbar__item">
				<a class="" href="<?php $this->options->siteUrl();?>archives.html">
					<i class="fa fa-history fa-2x" aria-hidden="true"></i>文章
				</a>
			</li>			
			<li class="footer-tabbar__item">
